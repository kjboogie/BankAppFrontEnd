...
import { CreditcardInsertComponent } from './creditcard-insert/creditcard-insert.component';
import { CreditcardDisplayComponent } from './creditcard-display/creditcard-display.component';
import { InsurancepolicyInsertComponent } from './insurancepolicy-insert/insurancepolicy-insert.component';
import { InsurancepolicyDisplayComponent } from './insurancepolicy-display/insurancepolicy-display.component';
...
@NgModule({
  declarations: [
    ...
    CreditcardInsertComponent,
    CreditcardDisplayComponent,
    InsurancepolicyInsertComponent,
    InsurancepolicyDisplayComponent
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
